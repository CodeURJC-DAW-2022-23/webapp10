package com.nutri.backend.security.jwt;


import com.nutri.backend.security.RepositoryUserDetailService;
...
public class JwtTokenProvider {
    ...
    public Authentication getAuthentication(String token) {
        UserDetails userDetails = userDetailsService.loadUsersByName(getUsername(token));
